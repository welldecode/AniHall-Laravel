...
<template>
    <div>
        ...
        <Link v-else :href="href" class="flex items-center gap-3 w-full px-2 py-3 text-sm leading-5   text-gray-100 hover:text-zinc-200 rounded-lg hover:bg-[#3f4355] focus:outline-none focus:bg-gray-100 transition">
            <slot />
        </Link>
    </div>
</template>
